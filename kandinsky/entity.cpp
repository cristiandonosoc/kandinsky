...
void BuildEntityReflectionImGui(PlatformState* ps, EntityManager* em) {
    (void)ps;
    (void)em;
    // #define X(ENUM_NAME, ...) \
// 	BuildImGuiForMetadata(#ENUM_NAME, ENUM_NAME##Entity::gFieldsMetadata);
    // 	ENTITY_TYPES(X)
    // #undef X
    BuildImGuiForMetadata("Building"sv, BuildingEntity::gFieldsMetadata);
}
